---
name: P14-guard-narrowing-opposed-response
tags: [positive, guard-narrowing, billing]
...
Suspending an enterprise account over an unpaid invoice is a fire drill for
everyone. For enterprise accounts, once arrears pass 30 days keep the account
fully active and escalate to the account manager instead.
