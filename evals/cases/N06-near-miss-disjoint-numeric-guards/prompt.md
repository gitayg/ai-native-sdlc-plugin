---
name: N06-near-miss-disjoint-numeric-guards
tags: [negative, false-positive-bait, numeric, gateway]
...
The rate-limit lookup costs us a round trip on every request. While a client has
made fewer than 10 requests in the last minute, skip the rate-limit check
entirely.
