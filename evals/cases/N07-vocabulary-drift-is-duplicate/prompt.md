---
name: N07-vocabulary-drift-is-duplicate
tags: [negative, vocabulary-drift, billing]
...
When a subscriber terminates their plan, the billing service should cease
billing them from the end of the current cycle.
