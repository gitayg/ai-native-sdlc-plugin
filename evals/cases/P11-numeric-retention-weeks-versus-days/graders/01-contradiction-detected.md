...
Conflict under test: Six weeks is 42 days. R2 requires all personal data gone within 30 days of the request, so a mandatory reversible grace period of at least six weeks before anything is deleted guarantees R2 is missed on every request.
