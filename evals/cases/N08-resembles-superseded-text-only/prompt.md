---
name: N08-resembles-superseded-text-only
tags: [negative, superseded, billing]
...
We are seeing verified settlement callbacks that reference an invoice id we have
never issued. Park those in a review queue for the finance team rather than
processing them.
