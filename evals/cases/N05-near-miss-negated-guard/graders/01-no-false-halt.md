...
Why this is not a contradiction: R3's guard is the policy service NOT answering within 200 ms; the intent's guard is the policy service answering within 200 ms. The two guards are negations, so they are never both in force and the responses cannot collide however opposed allow and deny look.
