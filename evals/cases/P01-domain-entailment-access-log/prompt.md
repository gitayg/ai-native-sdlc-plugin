---
name: P01-domain-entailment-access-log
tags: [positive, domain-entailment, records]
...
Security want the access log kept for seven years so we can reconstruct who
looked at what during an investigation. Right now it ages out with everything
else and we lose the trail. Please make access-log entries exempt from the
normal clean-up and hold them for 7 years.
