...
Why this is not a contradiction: a tenant's own month-over-month trend is derived entirely from that tenant's records, so P1 is satisfied and R11's exclusion of other-tenant figures is not engaged. The intent touches the area a principle governs without crossing it, which must not be a halt.
