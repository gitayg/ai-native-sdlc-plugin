...
Conflict under test: P1 forbids renaming a field in a published payload; R6 publishes `amount_cents` on `invoice.issued`. Renaming it in place is a non-additive change to a contract integrators already consume.
