---
name: P08-constitution-inplace-webhook-rename
tags: [positive, constitution, billing]
...
`amount_cents` is wrong for currencies without cents and it has confused three
integrators this quarter. Rename the field on `invoice.issued` to
`amount_minor_units`.
