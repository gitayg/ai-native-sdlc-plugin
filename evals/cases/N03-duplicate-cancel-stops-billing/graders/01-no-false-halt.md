...
Why this is not a contradiction: R2 already says exactly this. The right answer is to cite R2 and stop, and to ask whether the real report is that R2 is not implemented — which is a defect, not an intent.
