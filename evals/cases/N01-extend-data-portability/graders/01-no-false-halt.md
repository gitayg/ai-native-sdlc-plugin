...
Why this is not a contradiction: nothing in the spec covers handing a subject a copy of their own data. R2 is about removing it, which is a different disposition on a different trigger, and no principle forbids a subject receiving their own records.
