...
Why this is not a contradiction: R5 already means consecutive days in arrears — an account that pays and falls behind again starts a new arrears period. Saying so explicitly makes the requirement more measurable without changing which accounts get suspended, which is a refinement in place under the same id.
