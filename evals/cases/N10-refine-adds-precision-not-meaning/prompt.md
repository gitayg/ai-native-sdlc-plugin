---
name: N10-refine-adds-precision-not-meaning
tags: [negative, refine, billing]
...
R5 should say more than 14 consecutive days. An account that clears its balance
and later falls behind again starts a fresh clock — that is what we have always
meant and what the code does.
