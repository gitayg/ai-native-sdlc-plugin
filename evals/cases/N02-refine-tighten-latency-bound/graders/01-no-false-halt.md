...
Why this is not a contradiction: under 300 ms sits strictly inside R2's under 500 ms. Tightening a bound on the same trigger is a refinement in place under the same id — every behaviour meeting the new bound already met the old one, so nothing previously agreed becomes false.
