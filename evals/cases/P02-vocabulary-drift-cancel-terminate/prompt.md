---
name: P02-vocabulary-drift-cancel-terminate
tags: [positive, vocabulary-drift, billing]
...
Finance want to recover the remainder of the committed term. When a subscriber
terminates their plan before the twelve months are up, the billing service
should issue one final charge at the next cycle covering the months left on
the commitment.
